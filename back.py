...
token = 'pts_pmqlvc6oi3ttm5aqgsgvb42de43rdmo4'

domain = 'aws.us.pangea.cloud'
# Create a Config object contain the Audit Config
config = PangeaConfig(domain=domain,config_id='pci_w7enpmwqzhm7e7kmjnrgtdrlosbgyfpk')
...
audit = Audit(token, config=config, config_id='pci_w7enpmwqzhm7e7kmjnrgtdrlosbgyfpk')


nest_asyncio.apply()

if os.getenv("GROQ_API_KEY") is None:
    os.environ["GROQ_API_KEY"] = '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'
...
def O_LLM_Mixtral(query):
    print("Groq!")
    client = Groq(
        api_key="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",
    )
...
def O_LLM_gemini(query):
    #global Gemini_API
    Gemini_API = "AIzaSyAZaCjR8imGilSWfQtPR4Nn3L498Av3paE"
...
def O_LLM_openai(query):
    client = OpenAI(api_key='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')
